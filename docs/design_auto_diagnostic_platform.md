...
| Objectif | Critère de Succès |
|----------|-------------------|
| Infrastructure as Code | Terraform pour provisionning Azure |
...
|----------|-------------|----------|
| **Monitoring temps réel** | télémétrie en direct (< 5s latency) | Visibilité instantanée de la flotte |
...
|----------------|------|----------------------------|
| **Dongle OBD** | Collecte données du véhicule | Envoie: DTC, télémétrie (temp, RPM, fuel) |
...
5. **Gérer configuration alertes** (seuils, destinataires, canaux)
